...
//    }
    ...
    if(problemdata.CondensedElements()) CondenseElements(&problemdata, cmesh_m);
    ...
    // deleting stuff
    if (cmesh_u) delete cmesh_u;
    if (cmesh_p) delete cmesh_p;
    if (cmesh_g) delete cmesh_g;
    if (cmesh_pm) delete cmesh_pm;
    if (cmesh_m) delete cmesh_m;
